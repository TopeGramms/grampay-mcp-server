...
export const CONFIG = {
    ...
    DEFAULT_BANK_NAME: process.env.GRAMPAY_DEFAULT_BANK_NAME ?? "",
    DEFAULT_BANK_ACCOUNT: process.env.GRAMPAY_DEFAULT_BANK_ACCOUNT ?? "",
    ...
    IVORYPAY_PUBLIC_KEY: process.env.IVORYPAY_PUBLIC_KEY ?? undefined,
