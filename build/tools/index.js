export const TOOLS = [
    ...
    },
    {
        ...
        description: "Execute cash-out (requires prepare token from previous step). Returns a structured GramPay receipt with status, transaction ID, amount, destination, and timestamp.",
        inputSchema: {
            type: "object",
            properties: {
                prepare_token: {
